...
fun toPosteringsType(posteringsTypeGrunnlag: PosteringsTypeGrunnlag): PosteringsType {
    ...
    val safePosteringsTypeGrunnlag =
        ...
        else posteringsTypeGrunnlag

    return posteringsTypeMapping[safePosteringsTypeGrunnlag]
...
private val posteringsTypeMapping = biMapOf(
    ...
    PosteringsTypeGrunnlag(InntektType.LOENNSINNTEKT, InntektBeskrivelse.ARBEIDSOPPHOLD_KOST, null) to PosteringsType.L_ARBEIDSOPPHOLD_KOST,
